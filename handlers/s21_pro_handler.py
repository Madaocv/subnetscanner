"""
S21 Pro Device Handler for Subnet Scanner

This module provides implementation for S21 Pro devices,
...
class S21ProHandler(DeviceHandler):
    ...
    def get_log_endpoint(self) -> str:
        """Return the WebSocket endpoint for S21 Pro logs"""
    ...
    def parse_logs(self, log_content: str) -> Dict[str, Any]:
        """
        Parse S21 Pro log format (plain text with timestamps)
    ...
    def normalize_message(self, message: str) -> str:
        """
        Normalize S21 Pro error messages for consistent grouping
        ...
        """
        # For S21 Pro errors, normalize common patterns related to pools
...
DeviceRegistry.register_handler("S21 Pro", S21ProHandler)
DeviceRegistry.register_detector("S21 Pro", S21ProHandler.detect)
